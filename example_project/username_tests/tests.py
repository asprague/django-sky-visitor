from example_project import tests as primary_tests
from example_project.tests import TestEmailRegister
...
# Tests to mirror form primary tests
TestForgotPasswordProcess = primary_tests.TestForgotPasswordProcess
